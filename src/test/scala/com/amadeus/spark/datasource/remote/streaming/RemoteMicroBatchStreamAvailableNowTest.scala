...
/**
 * Additional integration-style tests for AvailableNow behavior.
 * These tests require a mock server or test fixtures.
 */
class RemoteMicroBatchStreamAvailableNowIntegrationSpec extends AnyFunSpec with Matchers {

  describe("AvailableNow with Mock Data") {

    // Note: These tests would require setting up mock file discovery
    // They are placeholders for integration testing

    it("should be pending until mock infrastructure is available") {
      pending
    }
  }
}
